...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <div className="w-full max-w-sm text-center">
        <Link href="/"><Image src="/aurora.png" alt="Aurora" width={90} height={28} className="mx-auto mb-10" /></Link>
  ...
  return (
    <div className="w-full max-w-sm">
      <Link href="/"><Image src="/aurora.png" alt="Aurora" width={90} height={28} className="mb-10" /></Link>
