  ...
  return (
    <div className="space-y-5">
      ...
      <LegalCard title="Uso de la cuenta">
        <p>Al crear una cuenta en Aurora aceptas proporcionar información veraz y mantener tus credenciales de acceso de forma confidencial.</p>
      ...
      <LegalCard title="Pedidos y confirmación">
        ...
        <p>Aurora se reserva el derecho de cancelar pedidos por falta de stock o información incorrecta.</p>
      </LegalCard>
      ...
      <LegalCard title="Propiedad intelectual">
        <p>Todo el contenido de Aurora — incluyendo imágenes, textos, logotipos y diseño — es propiedad exclusiva de la marca.</p>
