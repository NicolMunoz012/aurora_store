...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5">
        <path fillRule="evenodd" d="M3.5 2A1.5 1.5 0 0 0 2 3.5V5c0 .325.103.625.279.876L5.78 10l-3.5 4.124A1.5 1.5 0 0 0 2 15v1.5A1.5 1.5 0 0 0 3.5 18h13a1.5 1.5 0 0 0 1.5-1.5V15a1.5 1.5 0 0 0-.279-.876L14.22 10l3.5-4.124A1.5 1.5 0 0 0 18 5V3.5A1.5 1.5 0 0 0 16.5 2h-13Z" clipRule="evenodd" />
      </svg>
    ),
  },
  {
...
export function AdminSidebar() {
  ...
  return (
    <aside className="flex w-72 shrink-0 flex-col border-r border-gray-200 bg-white">
      {/* Brand */}
      <div className="flex h-[52px] items-center gap-3 border-b border-cerise-700/30 bg-cerise-600/90 px-5">
        <Link href="/admin" className="flex items-center gap-3">
          <Image src="/icon.png" alt="Aurora Belleza" width={90} height={28} />
              ...
              <li key={item.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
                    active
                      ? "bg-cerise-50 text-cerise-700"
                      : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
                  }`}
                >
                  <span className={active ? "text-cerise-500" : "text-gray-400"}>
                    {item.icon}
                  </span>
                  {item.label}
                </Link>
      ...
      <div className="border-t border-gray-200 px-4 py-3">
        <p className="text-[10px] text-gray-400">Aurora Belleza © 2026</p>
      </div>
    </aside>
  );
}
